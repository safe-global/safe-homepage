...
export const coreContent = [
  {
    ...
    items: [
      {
        icon: <img src="/images/Core/blob-1.svg" alt="Safe blob 1" />,
      ...
      {
        icon: <img src="/images/Core/blob-2.svg" alt="Safe blob 2" />,
        title: 'Safe {CORE} API',
        text: 'Easily level up your application and empower your users with the most advanced account abstraction SDK. Cutting-edge functionality and the best UX.',
      },
      {
        icon: <img src="/images/Core/blob-3.svg" alt="Safe blob 3" />,
