...
import { type ParallaxTextProps } from '@/components/commonCMS/ParallaxText'
import { isAsset } from '@/lib/typeGuards'
import css from './styles.module.css'

const ParallaxEcosystemElement = (props: ParallaxTextProps) => {
...
export default ParallaxEcosystemElement
