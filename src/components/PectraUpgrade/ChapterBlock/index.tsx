    ...
    return (
        <Grid item xs={12} md={width} className={css.gridItems}>
            <div>
                ...
                <Typography color="primary.light" mt={2} className={css.chapter}>{text}</Typography>
...
const ChapterBlock = ({ variant, title, text, items }: BaseBlock & { variant: '3-columns' | '4-columns' }) => (
    <Container>
        <Grid container className={layoutCss.containerTinier} flexDirection="column" alignItems="center">
